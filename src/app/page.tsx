        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-black/80 max-w-2xl mx-auto">
              Experienced, insured, and skilled professionals delivering exceptional results
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center mb-16">
            ...
            <div>
              <div className="text-4xl lg:text-5xl font-light text-black mb-2">10+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-medium text-black mb-2">Nationwide Service</h3>
              <p className="text-sm text-black/70">Expert remodeling services available in all 50 states</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-medium text-black mb-2">Skilled Professionals</h3>
              <p className="text-sm text-black/70">Experienced technicians with safety training and expertise</p>
            </div>
          </div>
        </div>
      </section>
