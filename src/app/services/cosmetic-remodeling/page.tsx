...
export default function Page() {
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="mt-12 p-6 bg-[var(--brand-primary)]/10 border border-[var(--brand-primary)]/20 rounded-2xl">
            ...
            <p className="text-sm text-neutral-300">
              ...
              are outsourced to qualified subcontractors with our oversight and coordination.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Related Services */}
      <RelatedServices currentService="cosmetic-remodeling" />
    </main>
  );
}
